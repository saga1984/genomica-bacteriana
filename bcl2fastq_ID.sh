...
bcl2fastq -R ./ -r $(nproc) -p $(nproc) -w $(nproc) --no-lane-splitting --fastq-compression-level 9 --minimum-trimmed-read-length 70 -l NONE -o fastq_${ID} --sample-sheet ${samplesheet}
